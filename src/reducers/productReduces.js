import { PRODUCTS_LIST_FAIL, PRODUCTS_LIST_REQUEST, PRODUCTS_LIST_SUCCESS, PRODUCT_ADD_FAIL, PRODUCT_ADD_REQUEST, PRODUCT_ADD_SUCCESS, PRODUCT_DELETE_FAIL, PRODUCT_DELETE_REQUEST, PRODUCT_DELETE_SUCCESS, PRODUCT_FAVORITE_FAIL, PRODUCT_FAVORITE_REQUEST, PRODUCT_FAVORITE_SUCCESS, PRODUCT_ONE_FAIL, PRODUCT_ONE_REQUEST, PRODUCT_ONE_SUCCESS, PRODUCT_UPDATE_FAIL, PRODUCT_UPDATE_REQUEST, PRODUCT_UPDATE_SUCCESS } from "../constance/productConstance";
...
export const deleteProductReducer = (state = {}, action) => {
    switch (action.type) {
        ...
        case PRODUCT_DELETE_SUCCESS:
            return {loading: true, productDelete: action.payload};
